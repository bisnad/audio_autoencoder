...
audio_file_path = "D:/data/audio/Gutenberg/Night_and_Day_by_Virginia_Woolf_32khz.wav"
#audio_file_path = "../data/improvisation_audio"
audio_channels = 1
audio_sample_rate = 32000 # numer of audio samples per sec
audio_window_length = 2048 # size of audio window in number of samples
...
audio_ae_factors = [8, 8, 4] # Downsampling/upsampling factor per layer
...
load_weights = True
save_weights = True
disc_prior_weights_file = "results_v1_3_1_32khz_Gutenberg/weights/disc_prior_weights_epoch_200"
encoder_weights_file = "results_v1_3_1_32khz_Gutenberg/weights/encoder_weights_epoch_200"
decoder_weights_file = "results_v1_3_1_32khz_Gutenberg/weights/decoder_weights_epoch_200"
...
disc_scheduler = torch.optim.lr_scheduler.StepLR(disc_optimizer, step_size=50, gamma=0.1) # reduce the learning every 20 epochs by a factor of 10
audio_ae_scheduler = torch.optim.lr_scheduler.StepLR(audio_ae_optimizer, step_size=50, gamma=0.1) # reduce the learning every 20 epochs by a factor of 10
...
test_waveform, _ = torchaudio.load("E:/data/audio/Gutenberg/Night_and_Day_by_Virginia_Woolf_32khz.wav")

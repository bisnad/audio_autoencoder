"""
same as audio_aae_v1_3_1.py but with mse loss instead of cross-entropy loss for prior discriminator
"""
...
audio_file_path = "D:/Data/audio/Motion2Audio/stocos/Take6_PhantomLimb_part3_HQ_audio_crop_44khz.wav"
#audio_file_path = "../data/improvisation_audio"
audio_channels = 1
audio_sample_rate = 44100 # numer of audio samples per sec
...
load_weights = False
save_weights = True
disc_prior_weights_file = "results/weights/disc_prior_weights_epoch_150"
...
def disc_prior_loss(disc_real_output, disc_fake_output):
    ...
    real_loss = mse_loss(disc_real_output, ones)
    fake_loss = mse_loss(disc_fake_output, zeros)
...
def ae_loss(target_audio, pred_audio, disc_fake_output):
    ...
    _ae_fake_loss = mse_loss(torch.zeros_like(disc_fake_output), disc_fake_output)
...
test_waveform, _ = torchaudio.load("D:/Data/audio/Motion2Audio/stocos/Take6_PhantomLimb_part3_HQ_audio_crop_44khz.wav")
#test_waveform, _ = torchaudio.load("E:/data/audio/Motion2Audio/madeline_improvisation_32khz.wav")

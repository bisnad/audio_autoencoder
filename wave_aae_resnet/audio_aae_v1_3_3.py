...
audio_file_path = "D:/Data/audio/Motion2Audio/madeline_improvisation_16khz.wav"
audio_sample_rate = 16000 # numer of audio samples per sec
audio_channels = 1
...
audio_stft_scales = [1024, 512, 256, 128] # [2048, 1024, 512, 256, 128]
audio_stft_mag = True
...
audio_encoder_out, audio_encoder_info = audio_encoder(audio_encoder_in, with_info=True)
...
test_waveform, _ = torchaudio.load("D:/Data/audio/Motion2Audio/madeline_improvisation_16khz.wav")

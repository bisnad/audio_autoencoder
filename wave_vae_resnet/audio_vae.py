"""
same as audio_aae_v1_3_4.py but 
with using a variational instead of adversarial approach for the latent space distribution
"""
...
audio_files = ["Take3_RO_37-4-1_HQ_audio_crop_32khz.wav"]
...
load_weights = False
save_weights = True
encoder_weights_file = "results_v1/weights/encoder_weights_epoch_200"
decoder_weights_file = "results_v1/weights/decoder_weights_epoch_200"
...
ae_kld_loss_scale_max = 0.0
ae_kld_loss_incr = 0.0 # 0.0026
